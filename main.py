...
while True:
    ...
    if choice == "1":
        ...
        New_Movies = {"title": title,"rating": rating, "watched": False}
        ...
        movies.sort(key = top, reverse = True)
        print(movies)
        ...
        movies[id].update({"watched": True})
        print("Movie marked")
    elif choice == "5":
        # https://www.w3schools.com/python/python_lists_remove.asp
        id_2 = int(input("Enter the index of the movie to remove: "))
        movies.pop(id_2)
        print("Movie removed")
    elif choice == "6":
        print("Exiting...")
